...
static const char qt_meta_stringdata_QCollapsible[] = {
    "QCollapsible\0\0on_toggle_collapse()\0"
};
...
const QMetaObjectExtraData QCollapsible::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QCollapsible::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QCollapsible,
      qt_meta_data_QCollapsible, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QCollapsible::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QCollapsible))
...
const QMetaObject FileSelector::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_FileSelector,
