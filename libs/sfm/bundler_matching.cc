...
for (std::size_t i = 0; i < view_1.positions.size(); ++i) {
   ...
   if ((!view_1_backup.q1.isInside(view_1_backup.positions[i][0], view_1_backup.positions[i][1]))&&(!view_1_backup.q2.isInside(view_1_backup.positions[i][0], view_1_backup.positions[i][1])))
{  //std::cout << "FEATURE AUS 1 GELOESCHT" << std::endl;
   view_1_backup.positions.erase(view_1_backup.positions.begin()+i);
}   if ((!view_2_backup.q1.isInside(view_2_backup.positions[i][0], view_2_backup.positions[i][1]))&&(!view_2_backup.q2.isInside(view_2_backup.positions[i][0], view_2_backup.positions[i][1])))
...
qtest.addPoint(0,0);
qtest.addPoint(0,10);
qtest.addPoint(10,10);
qtest.addPoint(10,0);

std::cout << "Ist 0,0 drin: " << qtest.isInside(0,0) << std::endl;
std::cout << "Ist 5,5 drin: " << qtest.isInside(5,5) << std::endl;
std::cout << "Ist 10,10 drin: " << qtest.isInside(10,10) << std::endl;
std::cout << "Ist 15,5 drin: " << qtest.isInside(15,5) << std::endl;
std::cout << "Ist 5,15 drin: " << qtest.isInside(5,15) << std::endl;
std::cout << "Ist 15,15 drin: " << qtest.isInside(15,15) << std::endl;*/
