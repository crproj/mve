...
/*
int v1 = view_1_backup.positions.size();
int v2 = view_2_backup.positions.size();


view_1_backup.positions.clear();

view_2_backup.positions.clear();



std::cout << "View 1 size " << view_1.positions.size() << std::endl;
std::cout << "View 1 Backup size " << v1 << std::endl;
std::cout << "View 1 Backup size " << view_1_backup.positions.size() << std::endl;
std::cout << "View 2 size " << view_2.positions.size() << std::endl;
std::cout << "View 2 Backup size " << v2 << std::endl;
